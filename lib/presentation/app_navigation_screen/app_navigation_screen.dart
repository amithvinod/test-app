...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapMyordersContainer(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapLoginscreenTwo(BuildContext context) {
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the signInOneScreen.
  onTapSigninOne(BuildContext context) {
  ...
  onTapMyordersContainer(BuildContext context) {
  ...
  onTapWhishlist(BuildContext context) {
  ...
  /// Navigates to the addAddressOneScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the addAddressOneScreen.
  onTapAddaddressOne(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.addAddressOneScreen);
  }
}
